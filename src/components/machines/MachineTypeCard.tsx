...
const MachineTypeCard: React.FC<MachineTypeCardProps> = ({ 
  ...
  if (isAddCard) {
    return (
      <Card 
        onClick={handleClick}
        className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-slate-700/70 to-slate-900/70 border-dashed border-slate-600/50 flex flex-col items-center justify-center h-[320px]"
      >
        <div className="p-6 text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-blue-900/30 flex items-center justify-center group-hover:bg-blue-800/50 transition-colors duration-300">
            <span className="text-4xl text-blue-400 group-hover:text-blue-300">+</span>
          </div>
  ...
  return (
    <Card className="relative overflow-hidden h-[320px] cursor-default">
